        ...
        public get = (options: any):any => {
            ...
            switch(options.interface) {
                ...
                case "ICollectionManager":
                    ...
                    if (options.dataService) return (<ILazyLoadCollectionManager>this.$injector.get("virtualIndexedListView.lazyLoadCollectionManager")).createInstance({ items: options.items, dataService: options.dataService });                    
